...
Route::get('productpurhase/edit/{id}', 'ProductServiceController@purchasedit')->name('purchase.edit');
Route::get('productstatus/edit/{id}', 'ProductServiceController@statusedit')->name('status.edit');
Route::get('deliverystatus/edit/{id}', 'ProductServiceController@deliveredit')->name('delivery.edit');
Route::get('dimenstatus/edit/{id}', 'ProductServiceController@dimenedit')->name('dimen.edit');
Route::get('labelstatus/edit/{id}', 'ProductServiceController@labeledit')->name('label.edit');
Route::get('productservice/show/{id}', 'ProductServiceController@show')->name('productservice.show');
Route::put('productstatus/{id}', 'ProductServiceController@statusupdate')->name('status.update')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::put('product/purhase/status/{id}', 'ProductServiceController@purchaseupdate')->name('puchase.update')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::put('product/deliver/status/{id}', 'ProductServiceController@deliverupdate')->name('deliver.update')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::put('product/dimen/status/{id}', 'ProductServiceController@dimenupdate')->name('dimen.update')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('product/recive/{type}', 'ProductServiceController@prodrecive')->name('prod.recive');
Route::get('product/invoice/{type}', 'ProductServiceController@prodinvoice')->name('prod.invoice');
Route::get('product/ship/{type}', 'ProductServiceController@prodship')->name('prod.ship');
Route::get('product/disaprove/{type}', 'ProductServiceController@prodisapprove')->name('prod.disaprove');
Route::get('product/aprove/{type}', 'ProductServiceController@prodapprove')->name('prod.aprove');
Route::get('product/aproveed', 'ProductServiceController@prodapproved')->name('prod.aproved');
Route::get('product/purchase/{type}', 'ProductServiceController@prodpurchase')->name('prod.purchase');
Route::get('product/returnall/{type}', 'ProductServiceController@productreturn')->name('prod.return');
Route::get('productservicess/{type}', 'ProductServiceController@indextype')->name('productservicetype.index');
Route::get('productservice/index', 'ProductServiceController@index')->name('productservice.index');
Route::get(
    '/productservice/{id}/users', [
    'as' => 'prod.users.edit',
    'uses' => 'ProductServiceController@userEdit',
]
)->middleware(
    [
        'auth',
...
Route::get(
    '/productservice/{id}/store', [
    'as' => 'prod.store.edit',
    'uses' => 'ProductServiceController@storeEdit',
]
)->middleware(
    [
        'auth',
...
Route::get(
    '/productservice/{id}/return', [
    'as' => 'product.return',
    'uses' => 'ProductServiceController@prodreturn',
]
)->middleware(
    [
        'auth',
...
Route::put(
    '/productservice/{id}/stores', [
    'as' => 'prod.stores.update',
    'uses' => 'ProductServiceController@storeUpdate',
]
)->middleware(
    [
        'auth',
...
Route::put(
    '/productservice/{id}/users', [
    'as' => 'prod.users.update',
    'uses' => 'ProductServiceController@userUpdate',
]
)->middleware(
    [
        'auth',
...
Route::put('productlabel/{id}', 'ProductServiceController@labelupdate')->name('label.update')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::resource('acounts', 'AcountController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::resource('stores', 'StoreController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::resource('threepl', 'ThreeplController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::post('invoice/stores', 'InvoiceController@getstore')->name('invoice.stores');
Route::post('invoice/store', 'InvoiceController@prodstore')->name('invoice.store');
Route::get(
