                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="mb-3">{{__('Aapproved Product')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countaprod()}}
                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total')}}</p>
                                            <h6 class="mb-3">{{__('Recieved Product')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countrecprod()}}
                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total')}}</p>
                                            <h6 class="mb-3">{{__('Not-Approved Product')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countdisaprod()}}
                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total')}}</p>
                                            <h6 class="mb-3">{{__('Purchase Product')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countpurcprod()}}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="mb-0">{{\Auth::user()->counttotalprod()}} </h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
