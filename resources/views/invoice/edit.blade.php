                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                           ...
                                           {{ Form::text('invoicenum', null, array('class' => 'form-control')) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td  class="form-group pt-0">
                                    {{ Form::select('store', $store,null, array('class' => 'form-control prod_store select','data-url'=>route('invoice.store'))) }}
                            ...
                            <tr>
                                <td >
                                    <div class="form-group">
                                        {{ Form::hidden('description', null, ['class'=>'form-control description','rows'=>'1','placeholder'=>__('Description')]) }}
                                        {{ Form::text('thpl','', array('class' => 'form-control pro_description','required'=>'required','placeholder'=>__('3PL'))) }}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                    {{ Form::text('boxno','null', array('class' => 'form-control boxno','required'=>'required','placeholder'=>__('No of Box'))) }}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                    {{ Form::text('boxcost','null', array('class' => 'form-control boxcost','required'=>'required','placeholder'=>__('Box Cost'))) }}
                                    </div>
                                </td>
                                <td>
                                {{ Form::hide('expense','', array('class' => 'form-control expense','required'=>'required','placeholder'=>__('Expense'))) }}
                                </td>
                                <td>
                                {{ Form::hide('budget','', array('class' => 'form-control newbudget','required'=>'required','placeholder'=>__('Budget'))) }}
                                </td>
