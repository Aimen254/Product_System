                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                                    ...
                                                    @foreach($invoice->itemData as $key => $item)
                                                        ...
                                                        <div class="d-table-tr" style="border-bottom:1px solid grey;">
                                                            ...
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6="">{{$item->price}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">
                                                            ...
                                                            @if($invoice->discount_apply==1)
                                                                <div class="d-table-td w-2">
                                                                    <pre data-v-f2a183a6="">{{($item->discount!=0)? $item->discount:'-'}}</pre>
                                                                </div>
                                                            @else
                                                                <div class="d-table-td w-2">
                                                            ...
                                                            <div class="d-table-td w-4 text-right"><span>{{$item->price * $item->quantity}}</span></div>
                                                        </div>
                                                        <div class="d-table-tr" style="border-bottom:1px solid grey;">
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">{{$item->thpl}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-2">
                                                                <pre data-v-f2a183a6="">{{$item->boxno}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6="">{{$item->boxcost}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">
                                                                   @if(!empty($item->itemTax))
                                                            ...
                                                            <div class="d-table-td w-4 text-right"><span>{{$item->boxcost * $item->boxno}}</span></div>
                                                        </div>
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid grey;">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{$invoice->totalRate}}</pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6="">{{$invoice->totalTaxPrice }}</pre>
                                                </div>
                                                @if($invoice->discount_apply==1)
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">{{$invoice->totalDiscount}}</pre>
                                                    </div>
                                                @else
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$invoice->getSubTotal()}}</div>
                                                    </div>
                                                    @if($invoice->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{$invoice->getTotalDiscount()}}</div>
                                                        </div>
                                                    @endif
                                                    @if(!empty($invoice->taxesData))
                                                        @foreach($invoice->taxesData as $taxName => $taxPrice)
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value">{{ $taxPrice  }}</div>
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Processfee(2.95%)')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$invoice->getTotalpercent()}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Total')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$invoice->getTotalCost()-$invoice->getTotalDiscount()+$invoice->getTotalTax()}}</div>
                                                    </div>
                                                    <!--<div data-v-f2a183a6="" class="d-table-summary-item">-->
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{$invoice->getDue()}}</div>
                                                    </div>
                                                </div>
                                            </div>
