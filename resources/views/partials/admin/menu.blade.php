        ...
        <div class="navbar-content">
            @if(\Auth::user()->type != 'client')
                        ...
                        @if( Gate::check('manage project'))
                            ...
                            ? 'active dash-trigger' : ''}}">
                                ...
                                ><span class="dash-micon"><i class="ti ti-share"></i></span
                                    ><span class="dash-mtext">{{__('Patient System')}}</span
                                    ><span class="dash-arrow"><i data-feather="chevron-right"></i></span
                                    ></a>
                                <ul class="dash-submenu">
                                    @can('manage project')
                                        <li class="dash-item  {{Request::segment(1) == 'project' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.list' ||Request::route()->getName() == 'projects.index' || Request::route()->getName() == 'projects.show' || request()->is('projects/*') ? 'active' : ''}}">
                                            <a class="dash-link" href="{{route('projects.index')}}">{{__('Patients')}}</a>
                                        </li>
                                    @endcan
                ...
                <!--------------------- End User Managaement System----------------------------------->
                    ...
                    @if(\Auth::user()->type == 'Intern' &&  \Auth::user()->acount == 'Walmart')
                        <!-- Walmart products start -->
                        @if( Gate::check('manage walmart product & service') || Gate::check('manage walmart product & service'))
                            <li class="dash-item dash-hasmenu">
                                <a href="#!" class="dash-link ">
                                    <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span class="dash-mtext">{{__('Walmart Product')}}</span><span class="dash-arrow">
                                            <i data-feather="chevron-right"></i></span>
                                </a>
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if(Gate::check('manage product & service'))
                                        <li class="dash-item {{ (Request::segment(1) == 'amazon')?'active':''}}">
                                            <a href="{{ route('productservicetype.index',$type) }}" class="dash-link">{{__('Product & Services')}}
                                            </a>
                                        </li>
                                    @endif
                                    @can('manage product & service')
                                        <li class="dash-item {{ (Request::segment(1) == 'productdisapproved')?'active':'' }}">
                                            <a class="dash-link" href="{{route('prod.disaprove',$type)}}">{{__('Disapproved Products')}}</a>
                                        </li>
                                    @endcan
                                    @can('manage product & service')
                                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'amzproductpurchase' || Request::segment(1) == 'amzproductnotpurchase' ) ? 'active dash-trigger' : ''}}" href="#hr-report" data-toggle="collapse" role="button" aria-expanded="{{(Request::segment(1) == 'amzproductpurchase' || Request::segment(1) == 'amzproductnotpurchase') ? 'true' : 'false'}}">
                                            <a class="dash-link" href="#">{{__('Need to Purchase')}}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                            <ul class="dash-submenu">
                                                <li class="dash-item {{ request()->is('amzproductpurchase') ? 'active' : '' }}">
                                                    <a class="dash-link" href="{{ route('prod.purchase',$type) }}">{{__('Purchased Products')}}</a>
                                                </li>
                                                <li class="dash-item {{ request()->is('amzproductnotpurchase') ? 'active' : '' }}">
                                                    <a class="dash-link" href="{{ route('prod.aprove',$type) }}">{{__('Not Purchased Products')}}</a>
                                                </li>
                                    ...
                                    @endcan
                                    @can('manage product & service')
                                        <li class="dash-item {{ (Request::segment(1) == 'productrecived')?'active':'' }}">
                                            <a class="dash-link" href="{{route('prod.recive',$type)}}">{{__('Recieved Products')}}</a>
                                        </li>
                                    @endcan
                                    @can('manage product & service')
                                        <li class="dash-item {{ (Request::segment(1) == 'productinvoice')?'active':'' }}">
                                            <a class="dash-link" href="{{route('prod.invoice',$type)}}">{{__('Invoiced Products')}}</a>
                                        </li>
                                    @endcan
                                    @can('manage product & service')
                                        <li class="dash-item {{ (Request::segment(1) == 'productship')?'active':'' }}">
                                            <a class="dash-link" href="{{route('prod.ship',$type)}}">{{__('Shipped Products')}}</a>
                                        </li>
                                    @endcan
                                    @can('manage product & service')
                                        <li class="dash-item {{ (Request::segment(1) == 'productreturn')?'active':'' }}">
                                            <a class="dash-link" href="{{route('prod.return',$type)}}">{{__('Returned Products')}}</a>
                                        </li>
                                    @endcan
                        ...
                        @endif
                        <!-- walmart product end -->
                    @elseif(\Auth::user()->type == 'Intern' &&  \Auth::user()->acount == 'Amazon')
                        <!-- Amazon product start --> 
                        @if( Gate::check('manage amazon product & service') || Gate::check('manage amazon product & service'))
                            <li class="dash-item dash-hasmenu">
                                    <a href="#!" class="dash-link ">
                                       <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span class="dash-mtext">{{__('Amazon Products')}}</span><span class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                                    </a>
                                        <ul class="dash-submenu">
                                            <?php
                                            $type = "Amazon";
                                            ?>
                                            @if(Gate::check('manage amazon product & service'))
                                                <li class="dash-item {{ (Request::segment(1) == 'amazon')?'active':''}}">
                                                    <a href="{{ route('productservicetype.index',$type) }}" class="dash-link">{{__('Product & Services')}}
                                                    </a>
                                                </li>
                                            @endif
                                            @can('manage amazon product & service')
                                                <li class="dash-item {{ (Request::segment(1) == 'productdisapproved')?'active':'' }}">
                                                    <a class="dash-link" href="{{route('prod.disaprove',$type)}}">{{__('Disapproved Products')}}</a>
                                                </li>
                                            @endcan
                                            @can('manage amazon product & service')
                                                <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'productpurchase' || Request::segment(1) == 'productnotpurchase' ) ? 'active dash-trigger' : ''}}" href="#hr-report" data-toggle="collapse" role="button" aria-expanded="{{(Request::segment(1) == 'productpurchase' || Request::segment(1) == 'productnotpurchase') ? 'true' : 'false'}}">
                                                    <a class="dash-link" href="#">{{__('Need to Purchase')}}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                                    <ul class="dash-submenu">
                                                        <li class="dash-item {{ request()->is('productpurchase') ? 'active' : '' }}">
                                                            <a class="dash-link" href="{{ route('prod.purchase',$type) }}">{{__('Purchased Products')}}</a>
                                                        </li>
                                                        <li class="dash-item {{ request()->is('productnotpurchase') ? 'active' : '' }}">
                                                            <a class="dash-link" href="{{ route('prod.aprove',$type) }}">{{__('Not Purchased Products')}}</a>
                                                        </li>
                    ...
                    @else
                        ...
                        @endif
                                    ...
                                    @if( Gate::check('manage walmart product & service') || Gate::check('manage walmart product & service'))
                                        <li class="dash-item dash-hasmenu">
                                        <a class="dash-link" href="#">{{__('Walmart Product')}}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                            <ul class="dash-submenu">
                                                <?php
                                                $type = "Walmart";
                                                ?>
                                                @if(Gate::check('manage walmart product & service'))
                                                    <li class="dash-item {{ (Request::segment(1) == 'amazon')?'active':''}}">
                                                        <a href="{{ route('productservicetype.index',$type) }}" class="dash-link">{{__('Product & Services')}}
                                                        </a>
                                                    </li>
                                                @endif
                                                @can('manage walmart product & service')
                                                    <li class="dash-item {{ (Request::segment(1) == 'productdisapproved')?'active':'' }}">
                                                        <a class="dash-link" href="{{route('prod.disaprove',$type)}}">{{__('Disapproved Products')}}</a>
                                                    </li>
                                                @endcan
                                    ...
                                    @if(Gate::check('manage product & service'))
                                        <li class="dash-item {{ (Request::segment(1) == 'productstock')?'active':''}}">
                                        <a class="dash-link" href="{{ route('acounts.index') }}">{{__('Product Setup')}}</a>
                                        </li>
                                    @endif
                                </ul>
                            </li>
