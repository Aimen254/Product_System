...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Product Disapprove')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($productServices as $productService)
                                <tr class="font-style">
                                    ...
                                    <td>
                                        <a href="{{url($productService->sourcelink)}}" class="badge  bg-info " >
                                           source
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{url($productService->amzlink)}}" class="badge  bg-primary"   >
                                           Selling
                                        </a>
                                    </td>
                                    <td>
                                        ...
                                        <td class="Action">
                                            ...
                                            @can('edit product & service')
                                               <div class="action-btn bg-primary ">
                                                   <a href="#" class="btn btn-sm btn-primary  " data-url="{{ route('status.edit',$productService->id) }}" data-ajax-popup="true"  data-size="md" data-bs-toggle="tooltip" title="{{__('Edit Status')}}"  data-title="{{__('Edit Status')}}" style="margin-right: 10px;">
