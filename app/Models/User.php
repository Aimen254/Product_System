...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany('App\Models\Acount', 'id', 'acount_id')->get();
    }
    ...
    public function countdisaprod()
    {
        return ProductService::where('created_by', '=', $this->creatorId())->where('status','disapprove')->count();
    }
    public function countaprod()
    {
        return ProductService::where('created_by', '=', $this->creatorId())->where('status','approve')->count();
    }
    public function countrecprod()
    {
        return ProductService::where('created_by', '=', $this->creatorId())->where('recived','recieved')->count();
    }
    public function countpurcprod()
    {
        return ProductService::where('created_by', '=', $this->creatorId())->where('purchase','purchased')->count();
    }
    public function counttotalprod()
    {
        return ProductService::where('created_by', '=', $this->creatorId())->count();
    }
    ...
    {
        return $this->belongsToMany('App\Models\ProductService', 'user_products', 'user_id', 'product_id');
    }
