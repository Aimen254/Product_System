...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Product Purchase')); ?></li>
<?php $__env->stopSection(); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Recieve_status')); ?></th>
                                <th><?php echo e(__('Add_Store')); ?></th>
                            ...
                            <?php $__currentLoopData = $productServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="font-style">
                                    ...
                                    <td>
                                        <a href="#" data-size="md" data-url="<?php echo e(route('prod.store.edit',$productService->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add User')); ?>" class="btn btn-sm btn-primary">
                                            <i class="ti ti-plus"></i>
                                        </a>
                                    </td>
                                    <td>
                                        ...
                                        <td class="Action" >
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit product & service')): ?>
                                                  <div class="action-btn">
                                                   <a href="#" class="btn btn-sm btn-primary  " data-url="<?php echo e(route('delivery.edit',$productService->id)); ?>" data-ajax-popup="true"  data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Purchase Status')); ?>"  data-title="<?php echo e(__('Edit Status')); ?>" style="margin-left: 60px; ">
                                                   <span class="btn-inner--icon"><?php echo e(__('Delivery')); ?></span>
                                                    </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\product\resources\views/productservice/puchase.blade.php ENDPATH**/ ?>