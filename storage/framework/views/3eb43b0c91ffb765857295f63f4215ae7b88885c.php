                      ...
                      <?php if( Gate::check('manage product & service') || Gate::check('manage product & service')): ?>
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if( Gate::check('manage product & service') || Gate::check('manage product & service')): ?>
                                    <li class="dash-item dash-hasmenu">
                                    <a class="dash-link" href="#"><?php echo e(__('Amazon Product')); ?><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            <?php
                                            $type = "Amazon";
                                            ?>
...
<?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>