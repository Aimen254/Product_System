<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="<?php echo e(route('threepl.index')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e((Request::route()->getName() == 'threepl.index' ) ? 'active' : ''); ?>   "><?php echo e(__('3 PL')); ?><div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\productsystm\resources\views/layouts/account_setup.blade.php ENDPATH**/ ?>