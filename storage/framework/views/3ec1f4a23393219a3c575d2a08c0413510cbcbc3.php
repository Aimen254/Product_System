                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($invoice->invoicenum); ?></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                                    ...
                                                    <?php $__currentLoopData = $invoice->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="d-table-tr" style="border-bottom:1px solid grey;">
                                                            ...
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->price); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">
                                                            ...
                                                            <?php if($invoice->discount_apply==1): ?>
                                                                <div class="d-table-td w-2">
                                                                    <pre data-v-f2a183a6=""><?php echo e(($item->discount!=0)? $item->discount:'-'); ?></pre>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="d-table-td w-2">
                                                            ...
                                                            <div class="d-table-td w-4 text-right"><span><?php echo e($item->price * $item->quantity); ?></span></div>
                                                        </div>
                                                        <div class="d-table-tr" style="border-bottom:1px solid grey;">
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->thpl); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-2">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->boxno); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->boxcost); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">
                                                                   <?php if(!empty($item->itemTax)): ?>
                                                            ...
                                                            <div class="d-table-td w-4 text-right"><span><?php echo e($item->boxcost * $item->boxno); ?></span></div>
                                                        </div>
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid grey;">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e($invoice->totalRate); ?></pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6=""><?php echo e($invoice->totalTaxPrice); ?></pre>
                                                </div>
                                                <?php if($invoice->discount_apply==1): ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6=""><?php echo e($invoice->totalDiscount); ?></pre>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span><?php echo e($invoice->getSubTotal()); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($invoice->getSubTotal()); ?></div>
                                                    </div>
                                                    <?php if($invoice->getTotalDiscount()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e($invoice->getTotalDiscount()); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if(!empty($invoice->taxesData)): ?>
                                                        <?php $__currentLoopData = $invoice->taxesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxPrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value"><?php echo e($taxPrice); ?></div>
                                                            </div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Processfee(2.95%)')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($invoice->getTotalpercent()); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Total')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($invoice->getTotalCost()-$invoice->getTotalDiscount()+$invoice->getTotalTax()); ?></div>
                                                    </div>
                                                    <!--<div data-v-f2a183a6="" class="d-table-summary-item">-->
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($invoice->getDue()); ?></div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/invoice/templates/template1.blade.php ENDPATH**/ ?>