...
<div class="row">
        ...
        <div class="form-group col-md-4">
         ...
         <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::text('asin',null, array('class' => 'form-control','required'=>'required'))); ?>
         ...
         <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                <?php echo e(Form::text('amzlink',null, array('class' => 'form-control','required'=>'required'))); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                <?php echo e(Form::text('sourcelink',null, array('class' => 'form-control','required'=>'required'))); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                <?php echo e(Form::number('asourceprice',null, array('class' => 'form-control','required'=>'required','step'=>'0.01','id'=>'srcprice'))); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::number('sourceprice',null, array('class' => 'form-control','required'=>'required','step'=>'0.01','id'=>'asrcprice'))); ?>
        ...
        <div class="col-md-4">
            ...
            <div class="form-icon-user">
            <?php echo e(Form::number('purchase_price',null, array('class' => 'form-control','required'=>'required','step'=>'0.01' ,'id'=>'costex'))); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::number('sale_price',null, array('class' => 'form-control','required'=>'required','step'=>'0.01','id'=>'saleprice'))); ?>
...
</script><?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/productservice/edit.blade.php ENDPATH**/ ?>