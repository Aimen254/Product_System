<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Budget Vs Actual: ')); ?><?php echo e($budget->name); ?>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <a href="<?php echo e(route('budget.index')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Back')); ?></a>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="col-xl-3 col-md-6 col-lg-3">
        <div class="card p-4 mb-4">
            <h6 class="report-text mb-0"><?php echo e(__('Year :')); ?> <?php echo e($budget->from); ?></h6>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/amarcmar/public_html/crm/resources/views/budget/show.blade.php ENDPATH**/ ?>