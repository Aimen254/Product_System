...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Product Disapprove')); ?></li>
<?php $__env->stopSection(); ?>
                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $productServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="font-style">
                                    ...
                                    <td>
                                        <a href="<?php echo e(url($productService->sourcelink)); ?>" class="badge  bg-info " >
                                           source
                                        </a>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(url($productService->amzlink)); ?>" class="badge  bg-primary"   >
                                           Selling
                                        </a>
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/productservice/disaprove.blade.php ENDPATH**/ ?>