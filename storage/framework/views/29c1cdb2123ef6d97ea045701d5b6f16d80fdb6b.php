                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="mb-3"><?php echo e(__('Aapproved Product')); ?></h6>
                                            <h3 class="mb-0"><?php echo e(\Auth::user()->countaprod()); ?>
                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                            <h6 class="mb-3"><?php echo e(__('Recieved Product')); ?></h6>
                                            <h3 class="mb-0"><?php echo e(\Auth::user()->countrecprod()); ?>
                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                            <h6 class="mb-3"><?php echo e(__('Not-Approved Product')); ?></h6>
                                            <h3 class="mb-0"><?php echo e(\Auth::user()->countdisaprod()); ?>
                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                            <h6 class="mb-3"><?php echo e(__('Purchase Product')); ?></h6>
                                            <h3 class="mb-0"><?php echo e(\Auth::user()->countpurcprod()); ?>
                                ...
                                <div class="col-lg-2 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                            <h6 class="mb-3"><?php echo e(__('Products')); ?></h6>
                                            </br>
                                            <h3 class="mb-0"><?php echo e(\Auth::user()->counttotalprod()); ?> </h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>