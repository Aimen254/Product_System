...
<?php $__env->startSection('breadcrumb'); ?>
   <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Product Approve')); ?></li>
<?php $__env->stopSection(); ?>
                                ...
                                <tr class="font-style">
                                    ...
                                    <?php if(Gate::check('edit product & service') || Gate::check('delete product & service')): ?>
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit product & service')): ?>
                                               <div class="">
                                                   <a href="#" class="btn btn-sm btn-primary  " data-url="<?php echo e(route('purchase.edit',$productService->id)); ?>" data-ajax-popup="true"  data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Purchase Status')); ?>"  data-title="<?php echo e(__('Purchase Status')); ?>" style="margin-right: 10px;">
                                                   <span class="btn-inner--icon"><?php echo e(__('Purchase')); ?></span>
                                                    </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\product\resources\views/productservice/aprove.blade.php ENDPATH**/ ?>