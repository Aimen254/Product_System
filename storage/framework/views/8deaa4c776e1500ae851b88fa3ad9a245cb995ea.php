                        ...
                        <div class="card-header-right">
                            <div class="btn-group card-option">
                                <div class="col-auto"><span class="badge rounded-pill bg-primary"><?php echo e($productService->purchase); ?></span>
                                 ...
                                 <a href="<?php echo e(url($productService->sourcelink)); ?>" class="badge  bg-info">source link</a>&nbsp; &nbsp; 
                                <a href="<?php echo e(url($productService->amzlink)); ?>" class="badge  bg-danger">Amazon Link</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/productservice/show.blade.php ENDPATH**/ ?>