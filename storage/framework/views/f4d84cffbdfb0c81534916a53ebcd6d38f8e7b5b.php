...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-6 form-group">
            <?php echo e(Form::label('acount_id', __('Select Acount'),['class'=>'form-label'])); ?>

            <?php echo Form::select('acount_id', $access, null,array('class' => 'form-control select3')); ?>

            
        </div>
        <div class="col-6 form-group">
            <?php echo e(Form::label('store_id', __('Select Store'),['class'=>'form-label'])); ?>

            <?php echo e(Form::select('store_id[]', $store,false, array('class' => 'form-control select2','id'=>'choices-multiple3','multiple'=>''))); ?>
...
<?php /**PATH C:\xampp\htdocs\product\resources\views/user/create.blade.php ENDPATH**/ ?>