                                        ...
                                        <td class="Action" >
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit product & service')): ?>
                                                  <div class="action-btn">
                                                   <a href="<?php echo e(route('dimen.edit',$productService->id)); ?>" class="btn btn-sm btn-primary  " title="<?php echo e(__('Purchase Status')); ?>"  data-title="<?php echo e(__('Edit Status')); ?>" style="margin-left: 60px; ">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/productservice/recieve.blade.php ENDPATH**/ ?>