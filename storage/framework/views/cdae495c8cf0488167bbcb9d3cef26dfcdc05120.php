...
<div class="modal-body">
    <div class="row">
        ...
        <div class=" form-group">
            ...
            <?php echo Form::select('acount_id', $access, null,array('class' => 'form-control select3','required'=>'required')); ?>
...
<?php /**PATH C:\xampp\htdocs\product\resources\views/clients/create.blade.php ENDPATH**/ ?>