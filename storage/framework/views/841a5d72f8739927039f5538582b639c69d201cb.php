...
<div class="modal-body">
    ...
    <div class="col-md-6 delivershow"  style="display: none;">
         <div class="form-group">
            <?php echo e(Form::label('pickupdate', __('Pickup date'),['class'=>'form-label'])); ?>

            <?php echo e(Form::date('pickupdate', '', array('class' => 'form-control','required'=>'required'))); ?>

        </div>
    </div>
    <div class="col-md-6 delivershow"  style="display: none;">
         <div class="form-group">
            <?php echo e(Form::label('pickuptime', __('Pickup Time'),['class'=>'form-label'])); ?>

            <?php echo e(Form::time('pickuptime', '', array('class' => 'form-control','required'=>'required'))); ?>
...
</script><?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/productservice/editdelivery.blade.php ENDPATH**/ ?>