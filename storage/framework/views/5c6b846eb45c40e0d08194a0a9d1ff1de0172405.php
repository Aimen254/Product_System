...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <div class="dropdown-menu dropdown-menu-right task-filter-actions dropdown-steady" id="task_status">
         ...
         <a href="#" class="btn btn-primary btn-sm" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="btn-inner--icon"><?php echo e(__('project')); ?></span>
        </a>
         <div class="dropdown-menu dropdown-menu-right project-filter-actions dropdown-steady" id="task_projects">
            <?php $__currentLoopData = $proj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="dropdown-item filter-action pl-4" href="#"><?php echo e(__($pro)); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
 ...
 <script>
  ...
  // when check project
            $(".project-filter-actions").on('click', '.filter-action', function (e) {
                     $(".project-filter-actions").removeClass("active");
                        $(this).addClass('active');  
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/amarcmar/public_html/crm/resources/views/project_task/taskboard.blade.php ENDPATH**/ ?>