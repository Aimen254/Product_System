...
<div class="col-md-12">
<div class="float-end">
<a href="#"  title="<?php echo e(__('Create New User')); ?>" onclick="show()" class="btn btn-sm btn-primary">
                        Advance Filters
                    </a>
</div>
</div>
                        ...
                        <div class="row"  id="filters" style="display:none;">
                             <div class="col-md-2">
                                <select id="project" name="" onchange="get()"  class="form-control  create">                       
                                    ...
                                    <?php if($projects = $task->projects()): ?>
                                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option ><?php echo e($project->project_name); ?></option>
                             ...
                             <div class="col-md-2">
                                ...
                                <?php $__currentLoopData = \App\Models\ProjectTask:: $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option><?php echo e(__($val)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                             <div class="col-md-2">
...
</script><?php /**PATH /home3/amarcmar/public_html/crm/resources/views/project_task/list.blade.php ENDPATH**/ ?>