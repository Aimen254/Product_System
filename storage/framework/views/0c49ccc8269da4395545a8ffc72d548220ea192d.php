...
<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="py-1">
            <span class="text-muted">  <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Devloped by ')); ?> 
            <a href="<?php echo e(url('https://archetives.com/')); ?>">Archetives Solution</a> <?php echo e(date('Y')); ?></span>
        </div>
...
<?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/partials/admin/footer.blade.php ENDPATH**/ ?>