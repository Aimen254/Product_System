                        ...
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td  class="form-group pt-0">
                                    <?php echo e(Form::select('store', $store,'', array('class' => 'form-control  prod_store','data-url'=>route('invoice.store'),'required'=>'required'))); ?>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                    <?php echo e(Form::hidden('description', null, ['class'=>'form-control description','rows'=>'2','placeholder'=>__('Description')])); ?>
                                ...
                                <td>
                                    <div class="form-group">
                                    <?php echo e(Form::text('boxno','', array('class' => 'form-control boxno','required'=>'required','placeholder'=>__('No of Box')))); ?>

                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                    <?php echo e(Form::text('boxcost','', array('class' => 'form-control boxcost','required'=>'required','placeholder'=>__('Box Cost')))); ?>

                                    </div>
                                </td>
                                <td >
                                <?php echo e(Form::text('expense','', array('class' => 'form-control expense','required'=>'required','placeholder'=>__('Expense')))); ?>

                                </td>
                                <td>
                                <?php echo e(Form::text('budget','', array('class' => 'form-control newbudget','required'=>'required','placeholder'=>__('Budget')))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\product\resources\views/invoice/create.blade.php ENDPATH**/ ?>