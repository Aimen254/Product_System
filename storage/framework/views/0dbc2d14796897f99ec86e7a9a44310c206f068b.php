...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="#" class="btn btn-sm btn-success  " data-url="<?php echo e(route('productservice.create')); ?>" data-ajax-popup="true"  data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Edit Status')); ?>"  data-title="<?php echo e(__('Edit Status')); ?>" >
                                                   <span class="btn-inner--icon"><?php echo e(__('Status')); ?></span>
                                                    </a>
                                                 
        <!-- <a href="<?php echo e(route('productservice.create')); ?>"  class="btn btn-sm btn-primary">
            <i class="ti ti-plus"></i>
        </a> -->
    </div>
<?php $__env->stopSection(); ?>
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit product & service')): ?>
                                                <div class="action-btn bg-primary ms-2">
                                                    ...
                                                    <a href="<?php echo e(route('productservice.edit',$productService->id)); ?>" class="mx-3 btn btn-sm  align-items-center" >
                                                        <i class="ti ti-pencil text-white"></i>
                                                    </a>
                                                </div>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\product\resources\views/productservice/index.blade.php ENDPATH**/ ?>