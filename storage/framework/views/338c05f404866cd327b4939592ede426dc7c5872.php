...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-4">
         ...
         <div class="col-md-4">
            <div class="form-group">
                <?php echo e(Form::label('amzlink', __('Selling Link'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
                <div class="form-icon-user">
        ...
        <div class="col-md-4">
           ...
           <div class="col-md-4">
            <div class="form-group">
                <?php echo e(Form::label('sourcelink', __('Reference Link'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
                <div class="form-icon-user">
                    <?php echo e(Form::text('reflink', '', array('class' => 'form-control','required'=>'required'))); ?>
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::number('shipping',0, array('class' => 'form-control','step'=>'0.01','id'=>'shiping'))); ?>

        </div>
        <div class="form-group col-md-4">
            <?php echo e(Form::label('tax_id', __('Tax'),['class'=>'form-label'])); ?>

            <?php echo e(Form::number('tax_id',0, array('class' => 'form-control','step'=>'0.01','id'=>'tax'))); ?>
...
<?php /**PATH /home/u702545921/domains/shopinbyld.com/public_html/resources/views/productservice/create.blade.php ENDPATH**/ ?>