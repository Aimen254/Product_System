                            ...
                            <div class="col text-end project_tasks_select">
                                <div class="dropdown btn btn-sm p-0">
                                    <a class=" btn btn-primary add-small " role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                        <i class="ti ti-plus mr-2"></i><?php echo e(__('Add Task on Timesheet')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/amarcmar/public_html/crm/resources/views/projects/timesheets/index.blade.php ENDPATH**/ ?>