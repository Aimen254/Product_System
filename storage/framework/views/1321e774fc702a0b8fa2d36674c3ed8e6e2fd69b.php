                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage product & service')): ?>
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'productdisapproved')?'active':''); ?>">
                                        <a class="dash-link" href="<?php echo e(route('prod.disaprove')); ?>"><?php echo e(__('Disapproved Products')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(Gate::check('manage product & service')): ?>
                                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'productpurchase')?'active':''); ?>">
                                        <a class="dash-link" href="#"><?php echo e(__('Need to Purchase')); ?><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task stage')): ?>
                                                <li class="dash-item  <?php echo e((Request::segment(1) == 'productpurchased')?'active':''); ?>">
                                                    <a class="dash-link" href="<?php echo e(route('prod.purchase')); ?>"><?php echo e(__('Purchased Products')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage bug status')): ?>
                                                <li class="dash-item <?php echo e((Request::segment(1) == 'productnotpurchase')?'active':''); ?>">
                                                    <a class="dash-link" href="<?php echo e(route('prod.aprove')); ?>"><?php echo e(__('Not Purchased Products')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                    </li>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage product & service')): ?>
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'productrecived')?'active':''); ?>">
                                        <a class="dash-link" href="<?php echo e(route('prod.recive')); ?>"><?php echo e(__('Recieved Products')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(Gate::check('manage product & service')): ?>
                                ...
                                <?php endif; ?>
                                <?php if(Gate::check('manage constant tax') || Gate::check('manage constant category') ||Gate::check('manage constant unit') ||Gate::check('manage constant payment method') ||Gate::check('manage constant custom field') ): ?>
                                        <li class="dash-item <?php echo e((Request::segment(1) == 'acounts' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'active dash-trigger' :''); ?>">
...
<?php /**PATH C:\xampp\htdocs\productsystm\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>